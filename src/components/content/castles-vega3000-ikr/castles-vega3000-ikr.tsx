...
const CastlesVega3000IkrContent: React.FC<CastlesVega3000IkrContentProps> = ({
	className = ''
}) => {
	return (
		<div className={className}>
			...
			<div className='content-section'>
				...
				<div className='subsection mb-6'>
					...
					<ul className='list-disc text-lg flex flex-col gap-3 pl-5'>
						<li>Подключить питание терминала к компьютеру.</li>
						<li>Подключить флешку с помощью переходника.</li>
						<li>
							Отключаем питание от компьютера и включаем снова, чтобы
				...
				<div className='subsection'>
					...
					<div className='flex'>
						<video controls className='w-full rounded-xl md:w-1/3 max-w-md'>
							<source
								src='/content/castles-vega3000-ikr/video/Vega3000 ИКР.mp4'
								type='video/mp4'
							/>
