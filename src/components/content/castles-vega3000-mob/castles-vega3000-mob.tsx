...
const CastlesVega3000MobContent: React.FC<CastlesVega3000MobContentProps> = ({ className = '' }) => {
			...
			<div className='content-section'>
				...
				<div className='subsection mb-8'>
					...
					<ul className='list-disc text-lg flex flex-col gap-5 pl-6'>
						...
						<li className='leading-7'>Многократно нажимаем красную кнопку до появления системного меню.</li>
						<li className='leading-7'>
