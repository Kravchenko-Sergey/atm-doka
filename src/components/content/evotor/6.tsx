			...
			<div className='content-section'>
				...
				<div className='subsection mb-8'>
					...
					<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
						...
						<li className='leading-7'>
							<a href='https://drive.google.com/uc?export=download&id=1f0PLsnjJLSsyf8BjNS7pERTeJYn48JLp' target='_blank' rel='noopener noreferrer' className='hover:underline text-[#f15024] font-medium transition-colors duration-200'>
								Файл прошивки
							</a>
						</li>
					</ul>
					...
					<ul className='list-disc text-lg flex flex-col gap-5 pl-6'>
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								<span>Скачайте</span>
								<a href='https://drive.google.com/uc?export=download&id=1zp8lapO00GubC86cOwkxooq8cZBRzLb5' target='_blank' rel='noopener noreferrer' className='hover:underline text-[#f15024] font-medium transition-colors duration-200 mx-1'>
									файл прошивки
								</a>
								<span>(актуальная версия —</span>
								<span className='border px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 ml-1'>6.0.16</span>
								<span>)</span>
							</div>
						</li>
						...
						<li className='leading-7'>Подключите флешку через переходник Type-C</li>
				...
				<div className='subsection'>
					...
					<div className='flex items-center justify-start gap-4 mb-6' id='2.3'>
						<h3 className='subsection-title text-xl md:text-2xl font-semibold'>Настройка eSIM</h3>
						<CopyLinkButton index='2.3' color='#f15024' />
					</div>

					<ul className='list-disc text-lg flex flex-col gap-5 pl-6'>
						<li className='leading-7'>Откройте настройки устройства (тройное нажатие на логотип Сбера)</li>
						<li className='leading-7'>Подключитесь к сети Wi-Fi</li>
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								<span>Перейдите:</span>
								<div className='flex flex-wrap items-center gap-1.5'>
									<span className='bg-[#f15024] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#e14520] transition-colors duration-200'>Мобильная сеть</span>
									<span className='font-medium'>→</span>
									<span className='bg-[#f15024] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#e14520] transition-colors duration-200'>Добавить eSIM</span>
								</div>
							</div>
						</li>
						...
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								<span>Перейдите:</span>
								<div className='flex flex-wrap items-center gap-1.5'>
									<span className='bg-[#f15024] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#e14520] transition-colors duration-200'>три точки</span>
									<span className='font-medium'>→</span>
									<span className='bg-[#f15024] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#e14520] transition-colors duration-200'>eSIM профили</span>
								</div>
							</div>
						</li>
						...
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								<span>Нажмите</span>
								<span className='bg-[#f15024] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#e14520] transition-colors duration-200 mx-1'>Получить QRCode</span>
							</div>
						</li>
						<li className='leading-7'>Отсканируйте полученный QR-код на терминале</li>
						<li className='leading-7'>Повторите для добавления eSIM других операторов при необходимости</li>
					</ul>
				</div>
			</div>
		</div>
