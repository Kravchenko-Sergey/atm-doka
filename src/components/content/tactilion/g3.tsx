					...
					<ul className='list-disc text-lg flex flex-col gap-5 pl-6'>
						...
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								...
								<span className='bg-[#ffd829] text-black px-1 rounded text-base font-medium whitespace-nowrap shrink-0 hover:bg-[#e6c225] transition-colors duration-200 mx-1'>
									1
								</span>
								<span>и</span>
								<span className='bg-[#ffd829] text-black px-1 rounded text-base font-medium whitespace-nowrap shrink-0 hover:bg-[#e6c225] transition-colors duration-200 ml-1'>
									F
								</span>
						...
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								<span>Открываем на ноутбуке программу</span>
								<a
									href='https://disk.yandex.ru/d/ntxPwIVh8dASHg'
									target='_blank'
									rel='noopener noreferrer'
						...
						<li className='leading-7'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								<span>После появления на экране ноутбука надписи</span>
								<span className='bg-[#ffd829] text-black px-1 rounded text-base font-medium whitespace-nowrap shrink-0 hover:bg-[#e6c225] transition-colors duration-200 mx-1'>
									Download success
								</span>
