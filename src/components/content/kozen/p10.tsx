...
const KozenP10Content: React.FC<KozenP10ContentProps> = ({ className = '' }) => {
			...
			<div className='content-section'>
				...
				<div className='subsection mb-8'>
					...
					<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
						...
						<li className='leading-7'>
							<a href='https://drive.google.com/uc?export=download&id=1MpQ1YbGuHUT9na83AT5qO6h6hvL-1-dw' target='_blank' rel='noopener noreferrer' className='hover:underline text-[#EF4444] font-medium transition-colors duration-200'>
								Файлы прошивки
							</a>
						</li>
					</ul>
