		...
		<div className={className}>
			...
			<div className='content-section'>
				<div className='flex items-center justify-start gap-4 mb-8 mt-8' id='2'>
					<h2 className='section-title text-3xl md:text-3xl font-semibold md:font-bold'>
						Прошивка
					</h2>
				...
				<div className='subsection mb-8'>
					...
					<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
						...
						<li className='leading-7'>
							<a
								href='https://drive.google.com/uc?export=download&id=1brc6f2ynOXfotC1spa62xiviLngDeX9M'
								target='_blank'
								rel='noopener noreferrer'
								className='hover:underline text-[#EF4444] font-medium transition-colors duration-200'
							>
			...
			<div className='content-section'>
				...
				<div className='subsection mb-8'>
					<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
						<li className='leading-7'>
							Включить терминал P12 с использованием комплектных кабелей
						</li>
						<li className='leading-7'>
							Открыть{' '}
							<span className='bg-[#EF4444] text-white px-1 rounded'>
								Настройки
							</span>{' '}
							и выбрать пункт{' '}
							<span className='bg-[#EF4444] text-white px-1 rounded'>
						...
						<li className='leading-7'>
							Нажать несколько раз на строку{' '}
							<span className='bg-[#EF4444] text-white px-1 rounded'>
								Версия прошивки
							</span>
						</li>
						...
						<div className='subsection mb-8'>
							<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
								<li className='leading-7'>
									...
									– проверка считывания чиповых карт
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										NFC TypeA 0 cm
									</span>{' '}
									– проверка считывания бесконтактных карт на расстоянии от
									экрана 0 см
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
								...
								<li className='leading-7'>
									...
									– проверка работы PIN-пада
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										Small Battery
									</span>{' '}
									– проверка работы резервного элемента питания CR2320
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										Backlight
									</span>{' '}
									– проверка работы подсветки экрана
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										Color
								...
								<li className='leading-7'>
									...
									– проверка работы автофокуса фотокамеры
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										Speaker
									</span>{' '}
									– проверка работы динамика
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										TouchScreen
								...
								<li className='leading-7'>
									...
									– проверка считывания касаний
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										Bluetooth
									</span>{' '}
									– проверка работы Bluetooth
								</li>
								<li className='leading-7'>
									<span className='bg-[#EF4444] text-white px-1 rounded'>
										WIFI
				...
				<div className='subsection'>
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Вставить карту в считыватель и извлечь ее через 2 секунды
							</li>
							<li className='leading-7'>
								На экране должен отобразиться UID карты
							</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если на экране отображен UID карты, то нажать на кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
									</span>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Приложить бесконтактную карту к центру экрана терминала
							</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
							...
							<li className='leading-7'>
								Поднести бесконтактную карту к центру экрана на расстоянии 4 см
								от него
							</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если PIN-код введен корректно, то на экране терминала
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Подсветка экрана несколько раз выключится и включится
							</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если подсветка экрана несколько раз выключилась и
										включилась, то нажать на кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
									</span>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Будет отображен белый, красный, зеленый и синий цвета
							</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если на экране отсутствуют неработающие пиксели, то нажать
										на кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Нажать на кнопку включения, кнопки{' '}
								<span className='bg-[#EF4444] text-white px-1 rounded'>
									Back
								</span>
								,{' '}
							...
							<li className='leading-7'>
								При успешном считывании всех нажатий проверка завершится
								автоматически
							</li>
						</ul>
					</div>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									...
									<span>
										и изображение не содержит видимых искажений, то нажать на
										кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если проверочная мелодия воспроизведена, то нажать на кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
									</span>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Провести пальцем по периметру экрана и по его диагоналям
							</li>
							<li className='leading-7'>
								Если все касания экрана будут считаны в указанных областях, то
								проверка завершится автоматически
							</li>
						</ul>
					</div>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если одновременное касание экрана в двух точках считано
										(экран окрасится в зеленый цвет), то нажать на кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
									</span>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								Запустить поиск устройств Bluetooth на смартфоне
							</li>
							<li className='leading-7'>Терминал P12 должен найти смартфон</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если терминал нашел BT устройство, то нажать на кнопку
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
									</span>
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							...
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если терминал найдет SSID обеих сетей, то на экране
										отобразится слово
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										Pass
					...
					<div className='mb-8'>
						...
						<ul className='list-disc text-lg flex flex-col gap-4 pl-6'>
							<li className='leading-7'>
								Установить SIM-карту в терминал (перезагрузка терминала не
								требуется)
							</li>
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
							...
							<li className='leading-7'>
								<div className='flex flex-wrap items-center gap-2 mt-1'>
									<span>
										Если терминал обнаружит SIM-карту и на экране отобразится
										сообщение
									</span>
									<span className='bg-[#EF4444] text-white px-1 rounded text-base font-medium whitespace-nowrap flex-shrink-0 hover:bg-[#eb3131] transition-colors duration-200 mx-1'>
										SIM1CardInserted
					...
					<div className='mt-8 p-4 rounded-lg'>
						<div className='text-base font-medium'>
							<div className='flex flex-wrap items-center gap-2 mt-1'>
								...
								<span>
									и подтвердить выход из приложения для проверки терминала
								</span>
							</div>
						</div>
					</div>
